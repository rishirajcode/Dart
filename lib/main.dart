...
import 'package:flutter_crud/services/database_handler.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<int> addUsers() async {
    User firstUser = User(name: "Jack", age: 44, country: "USA");
    User secondUser = User(name: "John", age: 30, country: "USA");
    User thirdUser = User(name: "Jake", age: 10, country: "UK");
